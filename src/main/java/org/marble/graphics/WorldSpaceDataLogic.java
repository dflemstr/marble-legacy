 ...
 */
final class WorldSpaceDataLogic implements
        GLSLShaderDataLogic {
    @Override
    public void applyData(final GLSLShaderObjectsState shader,
            final Mesh mesh, final Renderer renderer) {
        shader.setUniform("cameraPos", Camera.getCurrentCamera()
                .getLocation());
